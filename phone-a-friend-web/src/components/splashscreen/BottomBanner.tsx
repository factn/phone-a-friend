...
const BottomBanner: React.FC<Props> = ({ isMobile }) => (
  <MainDiv isMobile={isMobile} outsideMargin={Constants.OUTSIDE_MOBILE_MARGIN_PIXELS} bgColor={Colors.LIGHT_BLUE}>
    <Headline>Stay Connected</Headline>
    <Input isMobile={isMobile} id="namedInput" placeholder="Email address" type="text" name="email" />
    <Button className={isMobile ? 'mobile-splash-intro-button' : 'splash-intro-button'}>Submit</Button>
  </MainDiv>
);
